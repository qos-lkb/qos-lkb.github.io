...
const DD_TABLE_DESCRIPTIONS = [
    ...
    'question_banks' => '試題庫',
    'flashcard_sets' => '閃卡組（Anki／Quizizz 風格）',
    'flashcard_cards' => '閃卡（正／背面、提示）',
    'flashcard_card_reviews' => '登入者閃卡間隔重複進度',
    ...
    'summer_homework_questions' => '暑期功課題目（mcq／fill_blank／true_false／short_answer／long_answer）',
    'summer_homework_mcq_options' => '暑期功課選擇題選項',
    'summer_homework_fill_blanks' => '暑期功課填充題可接受答案（同 blank_index 可多列）',
    'summer_homework_short_answers' => '暑期功課短答題可接受答案（可多列）',
    'summer_homework_attempts' => '暑期功課每次呈交（responses_json；grading_json；teacher_marks_json 長答教師評分）',
...
const DD_COLUMN_HINTS = [
    ...
    'grading_json' => '暑期功課該次呈交的評分明細（對錯、選項索引／選項快照、填充／短答／是非；供分析）',
    'teacher_marks_json' => '長答題教師評分與評語（question_id → score／comment）',
    'correct_bool' => '是非題正解（1=是／true）',
    'max_score' => '題目滿分（長答可調；自動題多為 1）',
    'rubric_zh' => '長答評分指引（中）',
    'rubric_en' => '長答評分指引（英）',
    'moi' => '應考語言：E=英文、C=中文',
