...
import './modules/admin-subjects.js';
import './modules/admin-courses.js';
import './modules/admin-course-students.js';
import './modules/admin-course-report.js';
import './modules/admin-course-summer.js';
import './modules/admin-course-worksheets.js';
import './modules/admin-summer-analytics.js';
import './modules/admin-users.js';
