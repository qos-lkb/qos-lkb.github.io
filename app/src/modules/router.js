...
const global = window;
    ...
    const PATH_MATCHERS = [
        ...
        { re: /^\/flashcards\/([^/]+)$/, name: '/flashcards/:slug', keys: [1] },
        { re: /^\/flashcards\/?$/, name: '/flashcards' },
        ...
        { re: /^\/admin\/flashcard-sets\/new\/?$/, name: '/admin/flashcard-sets/new' },
        { re: /^\/admin\/flashcard-sets\/(\d+)\/edit\/?$/, name: '/admin/flashcard-sets/:id/edit', keys: [1] },
        { re: /^\/admin\/flashcard-sets\/?$/, name: '/admin/flashcard-sets' },
