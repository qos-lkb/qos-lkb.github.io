const t=window;function n(e,o){return t.AppRouter&&typeof t.AppRouter.t=="function"?t.AppRouter.t(e,o):(localStorage.getItem("science_sims_ui_lang")||"zh")==="zh"?e:o}function u(e){return String(e||"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[o])}function g(){var i,s;const e=t.__SITE_NAMES__||{};return((((s=(i=t.AppRouter)==null?void 0:i.getLang)==null?void 0:s.call(i))||"zh")==="zh"?e.zh:e.en)||e.zh||"伊中中科學學習平台"}function p(){return(t.ScienceApi&&ScienceApi.SITE_BASE||t.__SITE_BASE__||"")+"/login.php?next="+encodeURIComponent("app/")}function h(e){if(t.AppRouter&&typeof t.AppRouter.navigate=="function"){t.AppRouter.navigate(e);return}location.hash="#"+e}function r(e,o,i,s,a){return`
                ...
                <section class="guest-hero relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-900 text-white px-6 sm:px-10 py-12 sm:py-16 mb-10">
                    ...
                    <div class="relative z-10 max-w-2xl">
                        ...
                        <p class="mt-4 sm:mt-5 text-indigo-100 text-base sm:text-lg leading-relaxed">
                            ${n("中學科學互動學習空間：模擬實驗、自學課程、筆記與暑期功課，隨時探索。","An interactive science space for secondary learners: simulations, self-study courses, notes, and summer homework.")}
                        </p>
                        <div class="mt-8 flex flex-wrap gap-3">
                            <a href="${i}" class="guest-cta-primary inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-white text-indigo-950 font-semibold text-sm shadow-sm hover:bg-indigo-50 transition">
                                ${n("登入開始學習","Sign in to learn")}
                            </a>
                            ...
                            <button type="button" data-nav="/simulations/contribute" class="guest-cta-secondary inline-flex items-center justify-center px-5 py-2.5 rounded-lg border border-white/30 bg-white/10 text-white font-medium text-sm hover:bg-white/15 transition">
                                ${n("投稿模擬程式","Contribute a simulation")}
                            </button>
                            ...
                            <button type="button" data-nav="/summer-homework" class="guest-cta-secondary inline-flex items-center justify-center px-5 py-2.5 rounded-lg border border-white/30 bg-white/10 text-white font-medium text-sm hover:bg-white/15 transition">
                                ${n("暑期功課","Summer homework")}
                            </button>
                        </div>
                    </div>
                </section>

                <section class="guest-features space-y-8 px-1 sm:px-2" aria-label="${n("平台功能","What you can explore")}">
                    <p class="text-sm font-semibold text-slate-500 tracking-wide uppercase">${n("你可以探索","Explore")}</p>
                    ${r(s,"模擬程式","Simulations","互動物理、化學、生物與更多實驗，無需安裝即可操作。","Interactive physics, chemistry, biology and more — run in the browser.")}
