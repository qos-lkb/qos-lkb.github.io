...
- **準時／遲交**：僅在**已及格**時適用；以該生 **最高分那一次** 的 `submitted_at` 對照 `due_at`（同分取較早呈交）。
- **未及格**：已有呈交但未達及格線；**不**標為準時／遲交，須重做至及格。
- **欠交**：該習作尚無任何 attempt。
...
- 後台 → **課程管理** → 某課程的 **暑期功課**：班內學生 × 對應年級已發佈習作（準時／遲交／未及格／欠交、最高分）；題目欄或「N 次」可連到分析頁。
