            ...
            <table class="min-w-full text-sm">
                ...
                <?php foreach ($list as $row): ?>
                    <tr class="border-t">
                        ...
                        <td class="p-3"><a href="learning_note_edit.php?id=<?php echo (int) $row['id']; ?>" class="text-indigo-600">編輯</a></td>
                    </tr>
                <?php endforeach; ?>
                <?php if (!$list): ?>
