...
admin_page_start('工作紙', 'worksheets', [
    'actions' => admin_btn('worksheet_edit.php', '新增') . admin_btn('review_queue.php', '審核佇列', 'secondary'),
    'wide' => true,
]);
?>
            ...
            <table class="min-w-full text-sm">
                ...
                <?php foreach ($list as $row): ?>
                    <tr class="border-t border-slate-100">
                        ...
                        <td class="p-3"><a href="worksheet_edit.php?id=<?php echo (int) $row['id']; ?>" class="text-indigo-600 hover:underline">編輯</a></td>
                    </tr>
                <?php endforeach; ?>
                <?php if (!$list): ?>
