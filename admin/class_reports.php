...
bootstrap_public();
require_permission('class.manage_own', '../login.php?next=' . rawurlencode('admin/class_reports.php'));
...
admin_page_start('班級學習報告 — ' . (string) $class['name'], 'class_reports', [
    'actions' => admin_btn('classes.php', '返回班級列表', 'secondary') . ' ' . admin_btn($exportUrl, '匯出 CSV', 'secondary'),
    'wide' => true,
]);
?>
