...
bootstrap_public();
require_permission('worksheet.manage_any', '../login.php?next=' . rawurlencode('admin/worksheet_edit.php'));
...
<head>
    ...
    <title><?php echo $id ? '編輯' : '新增'; ?>工作紙 | Admin</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-slate-50 min-h-screen">
    <header class="bg-slate-900 text-white px-4 py-4"><div class="max-w-3xl mx-auto"><a href="worksheets.php" class="text-slate-300 text-sm">← 返回</a></div></header>
    <main class="max-w-3xl mx-auto px-4 py-8">
        ...
        <form id="edit-form" class="space-y-4 bg-white rounded-xl border p-6">
            ...
            <div><label class="text-sm font-medium">內容（中，Markdown）</label><textarea id="body-zh" class="w-full border rounded-lg px-3 py-2 mt-1 font-mono text-sm" rows="12"></textarea></div>
            <div><label class="text-sm font-medium">內容（英，Markdown）</label><textarea id="body-en" class="w-full border rounded-lg px-3 py-2 mt-1 font-mono text-sm" rows="12"></textarea></div>
